module.exports = {
    'Spawn1': {
        ...
        bodies: {
            ...
            claimer: [CLAIM,MOVE],
            pioneer: [WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE],
            scout: [MOVE]
        },
        memory: {
            harvester: { group: 2 },
            ...
            pioneer: { targetRoom: 'W15N37', group: 2 },
            scout: {}
        }
    },
